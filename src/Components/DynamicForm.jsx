...
const DynamicForm = (props) => {
    ...
    return textData.map((item, index) => {
      ...
      return (
        <div key={index} className="mb-4">
          <label htmlFor={fieldName} className="block text-sm font-semibold text-gray-600" style={{ fontWeight: 'bold', color: 'white' }}>
            {fieldName}
          </label>
          <input
            type="text"
  ...
  const renderDateInput = (dateData) => {
    return dateData.map((item, index) => {
      ...
      return (
        <div key={index} className="mb-4">
          <label htmlFor={fromDateKey} className="block text-sm font-semibold text-gray-600" style={{ fontWeight: 'bold', color: 'white' }}>
            {fieldName} - From Date
          </label>
          <input
            type="date"
          ...
          <label htmlFor={toDateKey} className="block text-sm font-semibold text-gray-600 mt-4" style={{ fontWeight: 'bold', color: 'white' }}> 
            {fieldName} - To Date
          </label>
          <input
            type="date"
